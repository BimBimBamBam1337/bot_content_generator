...
def regenerate_response_prompt(response: str) -> str:
    return f"""
Сгенерируй 12 пунктов контент-плана по теме: **{response}**.

Структура и оформление:
- Каждый пункт начинается с номера (1–12).
- Каждый пункт имеет формат:
  **[Название] — [Краткое описание идеи]. (Формат: Reels или Карусель)**
  - Конечная мысль: [итоговая мысль].

Сделай текст лаконичным, современным и связанным между собой логически.
Не добавляй никаких вводных или заключений — только 12 пунктов в указанной структуре.
"""
