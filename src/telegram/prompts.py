...
def regenerate_response_prompt(response: str) -> str:
    return f"""
Ниже приведён текст, который нужно перегенерировать, сохранив структуру, оформление и смысловую логику (эмодзи, заголовки, нумерацию, подзаголовки, форматирование и порядок секций).

{response}

Перегенерируй этот текст, сделав его более плавным, современным и целостным по смыслу, но без утраты структуры.
Не изменяй разметку, не убирай эмодзи и не меняй формат нумерации.
Верни итоговый текст полностью, в том же формате, с обновлёнными формулировками.
"""
